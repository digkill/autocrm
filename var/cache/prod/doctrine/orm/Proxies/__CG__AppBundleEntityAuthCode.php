 ...
 */
class AuthCode extends \AppBundle\Entity\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'client', 'user', 'redirectUri', 'token', 'expiresAt', 'scope'];
        }
