...
class Worker
{
    ...
    /**
     * @var \CRMBundle\Entity\Post
     *
     * @ORM\ManyToOne(targetEntity="CRMBundle\Entity\Post")
     * @ORM\JoinColumns({
     ...
     * Set post
     *
     * @param \CRMBundle\Entity\Post $post
     *
     * @return Worker
     */
    public function setPost(\CRMBundle\Entity\Post $post = null)
    {
        $this->post = $post;
