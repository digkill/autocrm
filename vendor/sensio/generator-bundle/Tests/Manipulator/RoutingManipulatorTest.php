...
class RoutingManipulatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function getImportedResourceYamlKeys()
    {
        return array(
            ...
            array('ApiBundle', '/', 'app'),
            array('ApiBundle', '//', 'app'),
            array('ApiBundle', '/{foo}', 'app'),
            array('ApiBundle', '/{_foo}', 'app'),
            array('ApiBundle', '/{/foo}', 'app'),
            array('ApiBundle', '/{/foo/}', 'app'),
            array('ApiBundle', '/{_locale}', 'app'),
            array('ApiBundle', '/{_locale}/foo', 'app_foo'),
            array('ApiBundle', '/{_locale}/foo/', 'app_foo'),
            array('ApiBundle', '/{_locale}/foo/{_format}', 'app_foo'),
            array('ApiBundle', '/{_locale}/foo/{_format}/', 'app_foo'),
            array('ApiBundle', '/{_locale}/foo/{_format}/bar', 'app_foo_bar'),
            array('ApiBundle', '/{_locale}/foo/{_format}/bar/', 'app_foo_bar'),
            array('ApiBundle', '/{_locale}/foo/{_format}/bar//', 'app_foo_bar'),
